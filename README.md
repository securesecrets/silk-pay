...
# Init SNIP-20 (SSCRT)
CODE_ID=1
INIT='{ "name": "SSCRT", "symbol": "SSCRT", "decimals": 6, "initial_balances": [{ "address": "secret1c3uk9nmtxwm6rzuylv35h2g8s3d27xm9jm9xrn", "amount": "1000000000000000000" }, { "address": "secret1kttggrsae37anw5llqtyrd7z7kyt27ml3r8p48", "amount": "1000000000000000000" }], "prng_seed": "RG9UaGVSaWdodFRoaW5nLg==", "config": { "public_total_supply": true, "enable_deposit": true, "enable_redeem": true, "enable_mint": false, "enable_burn": false } }'
...
# Init SILK (SILK)
INIT='{ "name": "SILK", "symbol": "SILK", "decimals": 8, "initial_balances": [{ "address": "secret1c3uk9nmtxwm6rzuylv35h2g8s3d27xm9jm9xrn", "amount": "3000000000000000000" }, { "address": "secret1kttggrsae37anw5llqtyrd7z7kyt27ml3r8p48", "amount": "3000000000000000000" }], "prng_seed": "RG9UaGVSaWdodFRoaW5nLg==", "config": { "public_total_supply": true, "enable_deposit": false, "enable_redeem": false, "enable_mint": false, "enable_burn": false } }'
...
# Query Txs
secretcli query compute query secret1vjecguu37pmd577339wrdp208ddzymku0apnlw '{"txs": {"address": "secret1c3uk9nmtxwm6rzuylv35h2g8s3d27xm9jm9xrn", "key": "DoTheRightThing.", "page": 0, "page_size": 50}}'

# Nominate new admin
secretcli tx compute execute secret1vjecguu37pmd577339wrdp208ddzymku0apnlw '{"nominate_new_admin":{"address": "secret1kttggrsae37anw5llqtyrd7z7kyt27ml3r8p48"}}' --from a -y --keyring-backend test --gas 3000000 --gas-prices=3.0uscrt
...
# Create send request
secretcli tx compute execute secret18vd8fpwxzck93qlwghaj6arh4p7c5n8978vsyg '{"send": { "recipient": "secret1vjecguu37pmd577339wrdp208ddzymku0apnlw", "amount": "555", "msg": "" }}' --from b -y --keyring-backend test --gas 3000000 --gas-prices=3.0uscrt
...
# Send payment
secretcli tx compute execute secret18r5szma8hm93pvx6lwpjwyxruw27e0k57tncfy '{"send": { "recipient": "secret1vjecguu37pmd577339wrdp208ddzymku0apnlw", "amount": "0", "msg": "eyJzZW5kX3BheW1lbnQiOiB7InBvc2l0aW9uIjogMH19" }}' --from a -y --keyring-backend test --gas 3000000 --gas-prices=3.0uscrt
```
